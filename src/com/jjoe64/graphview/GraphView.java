...
abstract public class GraphView extends LinearLayout {
	...
	private class GraphViewContentView extends View {
         ...
         * @param color
         */
        public GraphViewContentView(Context context, int color) {
			super(context);
            GraphViewConfig.color = color;
		...
		protected void onDraw(Canvas canvas) {
			...
			for (int i = 0; i < verlabels.length; i++) {
                ...
                paint.setColor(GraphViewConfig.color);
			...
			for (int i = 0; i < horlabels.length; i++) {
				...
				if(density==2.0) paint.setTextSize(20);  		//XHDPI
				else if (density==1.5) paint.setTextSize(15);	//HDPI
				else if (density==1.0) paint.setTextSize(11);	//MDPI
     ...
     * @param color
     */
    public GraphView(Context context, String title, int color) {
		super(context);
		setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
        ...
        addView(new GraphViewContentView(context, GraphViewConfig.color), new LayoutParams(
